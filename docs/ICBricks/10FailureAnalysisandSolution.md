...
## Cannot Find the COM Port During Firmware Upgrade?

**Case 1: Faulty USB Cable**

Check whether the USB cable can communicate properly. If an issue is detected, replace the USB cable.

**Case 2: Missing Serial Port Driver**

In this case, we recommend installing the serial port driver.
